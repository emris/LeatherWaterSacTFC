...
@Mod(modid="LeatherWaterSac", name="Leather Water Sac", version="1.2.b75", dependencies = "after:TerraFirmaCraft")
@NetworkMod(clientSideRequired = true, serverSideRequired = true, versionBounds = "[1.2.b75]")
